...
<div class="prof-card">
  ...
  <div class="prof-bio-area">
    <div class="prof-name"><?= e($u['display_name'] ?? $username) ?></div>
    <?php if (!empty($u['bio'])): ?>
  ...
  <div class="prof-actions">
    <?php if ($isOwn): ?>
      ...
      <a href="/settings" class="prof-btn-share"><i class="bi bi-gear"></i></a>
    <?php elseif ($loggedUser): ?>
      <a href="/dm/<?= e($username) ?>" class="prof-btn-edit"><i class="bi bi-send"></i> Mesaj</a>
